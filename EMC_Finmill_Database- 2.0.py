...
#Decision functions starts here
	def btnInputTrial(self, args):
		if args == 0:
			...
			#creating an instance of workbook
			self.hideFrontScreen()
			g = graphs(self.root, "#397a1b", "white")
			g.userWindow()
...
class graphs():
	...
	def backButton(self):
		#creating a button to take back to main screen
		backB = tk.Button(self.root, text= "Exit", bd = '5', height='1', width='10', font=(FONT_TYPE, 30), command=self.root.destroy)
		backB.place(relx=0.75, rely=0.6, anchor="center")
	...
	def userWindow(self):
		...
		graph_button.place(relx=0.25, rely=0.6, anchor='center')
